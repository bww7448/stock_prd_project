    ...
    for rand_day_weight2 in range(2, 3) :
        ...
        for rand_nas_weight in range(0,3) :
            ...
            if accuracy > zzin_weight["accuracy"][0] :
                ...
                best_100_df.to_csv("resources/{}item_best_100_day2_{}df.csv".format(item, rand_count) , encoding = "euc-kr")
                zzin_weight.to_csv("resources/{}item_best_weigt_day2_{}_df.csv".format(item, rand_count))
                print("바꼈지롱")
