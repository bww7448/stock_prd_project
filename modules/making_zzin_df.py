...
for i in range(5,105) :
    sample_df = making_zzin(stock_code="all", day_weight=0.04, nas_weight = 0.75, min_P_score=20, N_items=7, past_num = i).head()
...
zzin_df.to_csv("resources/item6_zzin_winlose2.csv", encoding = "euc-kr")